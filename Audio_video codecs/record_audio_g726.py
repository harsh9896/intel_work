...
codec = 'adpcm_g726' #change it to required codec
bitrate = '16k'
sample_rate='8k'
ffmpeg_command = ['ffmpeg', '-y', '-f', 'dshow', '-i', input_device, '-t', '10', '-acodec', codec, '-ar', sample_rate,  '-b:a', bitrate, '-ac', '1',  output_file]
#only mono is supported
#only 8000 sample rate supported
